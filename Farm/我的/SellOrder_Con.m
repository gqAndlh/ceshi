...
@interface SellOrder_Con ()<UITableViewDelegate,UITableViewDataSource>
@property(nonatomic,strong)UITableView*tableView;
@property(nonatomic,strong)NSMutableArray*dataArray;
@property (weak, nonatomic) IBOutlet UIScrollView *menuScrView;
@property (weak, nonatomic) IBOutlet UIView *line;
@property (nonatomic)NSInteger type;//订单状态
@end

@implementation SellOrder_Con
...
-(void)creatView{
    NSArray *arr=[NSArray arrayWithObjects:@"全部",@"待付款",@"待发货",@"待收货",@"已完成",@"取消拒收", nil];
